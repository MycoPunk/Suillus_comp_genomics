...
Suidis1_TMHMM<- data.frame(read.csv("Suidis1_TMHMM_SSP_output.txt", header = FALSE, col.names = "header"))
Suisubl1_TMHMM<- data.frame(read.csv("Suisubl1_TMHMM_SSP_output.txt", header = FALSE, col.names = "header"))
Suiplo1_TMHMM<- data.frame(read.csv("Suiplo1_TMHMM_SSP_output.txt", header = FALSE, col.names = "header"))
...
Suidis1_TMHMM_sm<- data.frame(Suidis1_TMHMM[ grep("# jgi", Suidis1_TMHMM$header),])
Suisubl1_TMHMM_sm<- data.frame(Suisubl1_TMHMM[ grep("# jgi", Suisubl1_TMHMM$header),])
Suiplo1_TMHMM_sm<- data.frame(Suiplo1_TMHMM[ grep("# jgi", Suiplo1_TMHMM$header),])
...
Suidis1_TMHMM_sm.by.col<- data.frame(cbind(Suidis1_TMHMM_sm[c(TRUE, FALSE), ],
                                           Suidis1_TMHMM_sm[c(FALSE, TRUE), ]))
Suisubl1_TMHMM_sm.by.col<- data.frame(cbind(Suisubl1_TMHMM_sm[c(TRUE, FALSE), ],
                                            Suisubl1_TMHMM_sm[c(FALSE, TRUE), ]))
Suiplo1_TMHMM_sm.by.col<- data.frame(cbind(Suiplo1_TMHMM_sm[c(TRUE, FALSE), ],
                                           Suiplo1_TMHMM_sm[c(FALSE, TRUE), ]))
...
Suidis1_TMHMM_no_TMD<- data.frame(Suidis1_TMHMM_sm.by.col[ grep("Number of predicted TMHs:  0", Suidis1_TMHMM_sm.by.col$X2),])
Suisubl1_TMHMM_no_TMD<- data.frame(Suisubl1_TMHMM_sm.by.col[ grep("Number of predicted TMHs:  0", Suisubl1_TMHMM_sm.by.col$X2),])
Suiplo1_TMHMM_no_TMD<- data.frame(Suiplo1_TMHMM_sm.by.col[ grep("Number of predicted TMHs:  0", Suiplo1_TMHMM_sm.by.col$X2),])
...
Suidis1_df<- isolate_aa(Suidis1_TMHMM_no_TMD)
Suisubl1_df<- isolate_aa(Suisubl1_TMHMM_no_TMD)
Suiplo1_df<- isolate_aa(Suiplo1_TMHMM_no_TMD)
#non-Suillus set
...
Suidis1_df.num<-transform(Suidis1_df, V1 = as.numeric(V1))
Suisubl1_df.num<-transform(Suisubl1_df, V1 = as.numeric(V1))
Suiplo1_df.num<-transform(Suiplo1_df, V1 = as.numeric(V1))
...
Suidis1_TMHMM_no_TMD_300<- Suidis1_df.num[Suidis1_df.num$V1 < 300, ]
Suisubl1_TMHMM_no_TMD_300<- Suisubl1_df.num[Suisubl1_df.num$V1 < 300, ]
Suiplo1_TMHMM_no_TMD_300<- Suiplo1_df.num[Suiplo1_df.num$V1 < 300, ]
...
Suidis1<- nrow(Suidis1_TMHMM_no_TMD_300)
Suisubl1<- nrow(Suisubl1_TMHMM_no_TMD_300)
Suiplo1<- nrow(Suiplo1_TMHMM_no_TMD_300)
...
Suifus1_in<- seqinr::read.fasta(file = "Suifus1_wo_stops.fasta", 
                                seqtype = "AA",as.string = TRUE, set.attributes = FALSE)
Suidis1_in<- seqinr::read.fasta(file = "Suidis1_wo_stops.fasta", 
                                seqtype = "AA",as.string = TRUE, set.attributes = FALSE)
Suisubl1_in<- seqinr::read.fasta(file = "Suisubl1_wo_stops.fasta", 
                                 seqtype = "AA",as.string = TRUE, set.attributes = FALSE)
Suiplo1_in<- seqinr::read.fasta(file = "Suiplo1_wo_stops.fasta", 
                                seqtype = "AA",as.string = TRUE, set.attributes = FALSE)
...
Suidis1_subset <- data.frame(substr(Suidis1_TMHMM_no_TMD_300$X1, 3,nchar(Suidis1_TMHMM_no_TMD_300$X1)))
Suidis1.2_subset<- isolate_ID(Suidis1_subset) 
Suidis1.3_subset<- data.frame(lapply(Suidis1.2_subset, gsub, pattern=' ', replacement=''))

Suisubl1_subset <- data.frame(substr(Suisubl1_TMHMM_no_TMD_300$X1, 3,nchar(Suisubl1_TMHMM_no_TMD_300$X1)))
Suisubl1.2_subset<- isolate_ID(Suisubl1_subset) 
Suisubl1.3_subset<- data.frame(lapply(Suisubl1.2_subset, gsub, pattern=' ', replacement=''))

Suiplo1_subset <- data.frame(substr(Suiplo1_TMHMM_no_TMD_300$X1, 3,nchar(Suiplo1_TMHMM_no_TMD_300$X1)))
Suiplo1.2_subset<- isolate_ID(Suiplo1_subset) 
Suiplo1.3_subset<- data.frame(lapply(Suiplo1.2_subset, gsub, pattern=' ', replacement=''))
...
names(Suidis1_in)<-lapply(names(Suidis1_in), gsub, pattern="\\|", replacement='_')
names(Suisubl1_in)<-lapply(names(Suisubl1_in), gsub, pattern="\\|", replacement='_')
names(Suiplo1_in)<-lapply(names(Suiplo1_in), gsub, pattern="\\|", replacement='_')
#non-suillus set
...
Suidis1_SSP_fastas<- Suidis1_in[c(which(names(Suidis1_in) %in% Suidis1.3_subset$V1))]
Suisubl1_SSP_fastas<- Suisubl1_in[c(which(names(Suisubl1_in) %in% Suisubl1.3_subset$V1))]
Suiplo1_SSP_fastas<- Suiplo1_in[c(which(names(Suiplo1_in) %in% Suiplo1.3_subset$V1))]
...
write.fasta(Suidis1_SSP_fastas, names = names(Suidis1_SSP_fastas), open = "w", nbchar = 60, as.string = FALSE, file.out = "Suidis1_SSPs_for_EffectorP.fasta")
write.fasta(Suisubl1_SSP_fastas, names = names(Suisubl1_SSP_fastas), open = "w", nbchar = 60, as.string = FALSE, file.out = "Suisubl1_SSPs_for_EffectorP.fasta")
write.fasta(Suiplo1_SSP_fastas, names = names(Suiplo1_SSP_fastas), open = "w", nbchar = 60, as.string = FALSE, file.out = "Suiplo1_SSPs_for_EffectorP.fasta")
...
Suidis1<- length(Suidis1_in)
Suisubl1<- length(Suisubl1_in)
Suiplo1<- length(Suiplo1_in)
...
results<- rbind(total_proteins[1,], total_SSPs[1,])
results.1<- t(results)
...
#slap it together
results_with_percentages<- cbind(results.1, percent_SSPs_out_of_total_genes)

colnames(results_with_percentages)
#renmae cols
colnames(results_with_percentages)<- c("n_proteins", "n_SSPs", "n_Effectors")
...
ortho_finder_SSP_results<- read.table("Statistics_PerSpecies_03_Jan_2019.csv", sep = ",", row.names = 1, header=TRUE)

#get SSP counts
results_with_percentages<- data.frame(results_with_percentages)
n_SSPs<- data.frame(results_with_percentages$n_SSPs)
rownames(n_SSPs)<- row.names(results_with_percentages)
colnames(n_SSPs)<- "n_SSPs"

#Get SSSP counts
SSP_vs_SSSP1<- ortho_finder_SSP_results[3,]
n_SSSP<- t(SSP_vs_SSSP1)
colnames(n_SSSP)<- "n_SSSPs"
rownames(n_SSSP)<- gsub(x = rownames(n_SSSP), pattern = "_SSPs_for_EffectorP", replacement = "")

#get n_proteins 
n_prot<- data.frame(results_with_percentages$n_proteins)
rownames(n_prot)<- row.names(results_with_percentages)
colnames(n_prot)<- "n_proteins"

#get genome size
genome_size_df<- read.csv("genome_size_data.csv")

#order
n_SSP_ordered<- n_SSPs[ order(rownames(n_SSPs)) , ,drop=F]
n_SSSP_ordered<- n_SSSP[ order(rownames(n_SSSP)) , ,drop = F]
n_proteins_ordered<- n_prot[ order(rownames(n_prot)) , ,drop = F]
genome_size_df_ordered<- genome_size_df[ order(genome_size_df$JGI.project.code) , , drop = F]

#bind
all_counts<- cbind(n_SSP_ordered, n_SSSP_ordered, n_proteins_ordered, genome_size = genome_size_df_ordered$genome_size)

#get percent SSSPs out of SSPs 
all_counts$percent_SSSPs_out_of_SSPs<- (all_counts$n_SSSPs) / (all_counts$n_SSPs) * 100

#get percent SSPs out of proteins 
all_counts$percent_SSP_out_of_proteins<- (all_counts$n_SSPs) / (all_counts$n_proteins) * 100

#print
write.csv(all_counts, quote = FALSE, file = "SSP_prot_genomesize_totals.csv")
