...
#read in files
expansions_files<- list.files(path ="~/bigdata/Suillus_comp_genomics/All_GOterms/fams_of_interest", pattern = "*_expansions.clean.IPR_anno_output.txt", full.names=T)
contractions_files<- list.files(path ="~/bigdata/Suillus_comp_genomics/All_GOterms/fams_of_interest", pattern = "*_contractions.clean.IPR_anno_output.txt", full.names=T)
...
expansions_names<- gsub("_expansions.clean.IPR_anno_output.txt", "", expansions_names)
names(expansions)<- expansions_names

contractions_names<- gsub(".*fams_of_interest/", "", contractions_files)
contractions_names<- gsub("_contractions.clean.IPR_anno_output.txt", "", contractions_names)
